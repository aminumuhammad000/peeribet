...
- **admin/**: The administrative dashboard and landing page (Vite).

## Getting Started

Refer to the README in each subdirectory for specific instructions on how to run and develop each component.
