...
const matches = [
  ...
  },
  {
    homeTeam: 'Lazio',
    awayTeam: 'Roma',
    homeLogo: 'https://ui-avatars.com/api/?name=LA&background=87CEEB&color=fff&rounded=true',
    awayLogo: 'https://ui-avatars.com/api/?name=RO&background=8B0000&color=fff&rounded=true',
    league: 'Serie A',
...
const seedMatches = async () => {
  try {
    const mongoUri = process.env.MONGODB_URI || 'mongodb://localhost:27017/peeritrade';
