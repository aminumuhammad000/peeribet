  ...
  return (
    <View style={styles.container}>
      <Svg width="260" height="200" viewBox="0 0 260 200" fill="none">
        ...
        <Rect x="79" y="133" width="4" height="12" fill="#3B82F6" />
        <Path d="M 76 168 Q 78 168 83 172 H 75 Z" fill="#050811" />
        <Rect x="87" y="145" width="4" height="23" fill="#FFD5C6" />
        <Rect x="87" y="133" width="4" height="12" fill="#3B82F6" />
        <Path d="M 84 168 Q 86 168 91 172 H 83 Z" fill="#050811" />
        ...
        <Rect x="70" y="88" width="5" height="12" fill="#FFD5C6" />
        <Path d="M 94 75 L 100 88 H 95 L 90 78 Z" fill="url(#jerseyGrad)" />
        <Rect x="95" y="88" width="5" height="12" fill="#FFD5C6" />
        ...
        <Rect x="169" y="133" width="4" height="12" fill="#3B82F6" />
        <Path d="M 166 168 Q 168 168 173 172 H 165 Z" fill="#050811" />
        <Rect x="177" y="145" width="4" height="23" fill="#FFD5C6" />
        <Rect x="177" y="133" width="4" height="12" fill="#3B82F6" />
        <Path d="M 174 168 Q 176 168 181 172 H 173 Z" fill="#050811" />
        ...
        <Rect x="160" y="88" width="5" height="12" fill="#FFD5C6" />
        <Path d="M 184 75 L 190 88 H 185 L 180 78 Z" fill="url(#jerseyGradRight)" />
        <Rect x="185" y="88" width="5" height="12" fill="#FFD5C6" />
