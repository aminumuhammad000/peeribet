...
import { CheckCircle, Trophy, ArrowRight } from 'lucide-react-native';
...
export default function AccountCreatedScreen() {
  ...
  useEffect(() => {
    ...
    Animated.sequence([
      ...
      // 2. Fade and slide up the text content
      Animated.parallel([
        ...
        <View style={styles.content}>
          ...
          >
            <View style={styles.badgeContainer}>
              ...
              <Text style={styles.badgeText}>Welcome to the Future of Trading</Text>
            </View>
